...
import { signInWithProvider, signOut } from "@/services/supabaseAuth";
...
const Header = () => {
  ...
  return (
    <header className="w-full sticky min-w-[320px] max-w-[600px] top-0 left-0 right-0 mx-auto mt-0 z-[200]">
