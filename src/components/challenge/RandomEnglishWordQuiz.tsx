...
const RandomEnglishWordQuiz = ({ userId }: RandomQuizProps) => {
  ...
  useEffect(() => {
    const fetchEnglishWordQuestions = async () => {
      try {
        const response = await fetch(`/api/getRandomQuiz?language=english&type=word`);
